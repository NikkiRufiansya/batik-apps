...
public class BatikAdapterPopular extends RecyclerView.Adapter<BatikAdapterPopular.MyView> {
    private Context context;
    private List<BatikModels> data;

    public BatikAdapterPopular(Context context, List<BatikModels> data) {
    ...
    @NonNull
    @Override
    public BatikAdapterPopular.MyView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_populer,parent, false);
        return new MyView(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BatikAdapterPopular.MyView holder, int position) {
